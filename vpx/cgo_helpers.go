...
func (x *CodecEncCfg) PassRef() (*C.vpx_codec_enc_cfg_t, *cgoAllocMap) {
	...
	var crc_2pass_vbr_corpus_complexity_allocs *cgoAllocMap
	ref37e25db9.rc_2pass_vbr_corpus_complexity, crc_2pass_vbr_corpus_complexity_allocs = (C.uint)(x.Rc2passVbrCorpusComplexity), cgoAllocsUnknown
	allocs37e25db9.Borrow(crc_2pass_vbr_corpus_complexity_allocs)
...
func (x *CodecEncCfg) Deref() {
	...
	x.Rc2passVbrCorpusComplexity = (uint32)(x.ref37e25db9.rc_2pass_vbr_corpus_complexity)
...
func (x *Image) Deref() {
	...
	hxfc4425b.Data = unsafe.Pointer(x.refc09455e3.img_data)
...
func (x *CodecFrameBuffer) Deref() {
	...
	hxf95e7c8.Data = unsafe.Pointer(x.refd319b8f1.data)
