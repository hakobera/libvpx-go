...
// FixedBuf as declared in vpx/vpx_encoder.h:99
...
// CodecPts type as declared in vpx/vpx_encoder.h:106
type CodecPts int64

// CodecFrameFlags type as declared in vpx/vpx_encoder.h:115
type CodecFrameFlags uint32

// CodecErFlags type as declared in vpx/vpx_encoder.h:131
type CodecErFlags uint32

// CodecCxPkt as declared in vpx/vpx_encoder.h:198
...
// CodecEncOutputCxPktCbFn type as declared in vpx/vpx_encoder.h:205
type CodecEncOutputCxPktCbFn func(pkt *CodecCxPkt, userData unsafe.Pointer)

// CodecPrivOutputCxPktCbPair as declared in vpx/vpx_encoder.h:212
...
// Rational as declared in vpx/vpx_encoder.h:221
...
// EncFrameFlags type as declared in vpx/vpx_encoder.h:259
type EncFrameFlags int

// CodecEncCfg as declared in vpx/vpx_encoder.h:694
type CodecEncCfg struct {
	...
	Rc2passVbrCorpusComplexity uint32
	KfMode                     KfMode
	KfMinDist                  uint32
	KfMaxDist                  uint32
...
// SvcExtraCfg as declared in vpx/vpx_encoder.h:708
type SvcExtraCfg C.vpx_svc_extra_cfg_t

// CodecCaps type as declared in vpx/vpx_codec.h:152
type CodecCaps int

// CodecFlags type as declared in vpx/vpx_codec.h:167
type CodecFlags int

// CodecIface as declared in vpx/vpx_codec.h:174
type CodecIface C.vpx_codec_iface_t

// CodecPriv as declared in vpx/vpx_codec.h:181
type CodecPriv C.vpx_codec_priv_t

// CodecIter type as declared in vpx/vpx_codec.h:187
type CodecIter unsafe.Pointer

// CodecCtx as declared in vpx/vpx_codec.h:211
type CodecCtx C.vpx_codec_ctx_t

// Image as declared in vpx/vpx_image.h:115
type Image struct {
	Fmt            ImageFormat
	Cs             ColorSpace
	Range          ColorRange
...
// ImageRect as declared in vpx/vpx_image.h:123
...
// CodecStreamInfo as declared in vpx/vpx_decoder.h:94
...
// CodecDecCfg as declared in vpx/vpx_decoder.h:111
...
// CodecPutFrameCbFn type as declared in vpx/vpx_decoder.h:252
type CodecPutFrameCbFn func(userPriv unsafe.Pointer, img *Image)

// CodecPutSliceCbFn type as declared in vpx/vpx_decoder.h:291
type CodecPutSliceCbFn func(userPriv unsafe.Pointer, img *Image, valid *ImageRect, update *ImageRect)

// CodecFrameBuffer as declared in vpx/vpx_frame_buffer.h:43
...
// GetFrameBufferCbFn type as declared in vpx/vpx_frame_buffer.h:63
type GetFrameBufferCbFn func(priv unsafe.Pointer, minSize uint, fb *CodecFrameBuffer) int32

// ReleaseFrameBufferCbFn type as declared in vpx/vpx_frame_buffer.h:76
