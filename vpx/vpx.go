...
func CodecEncConfigDefault(iface *CodecIface, cfg *CodecEncCfg, usage uint32) CodecErr {
	ciface, _ := (*C.vpx_codec_iface_t)(unsafe.Pointer(iface)), cgoAllocsUnknown
	ccfg, _ := cfg.PassRef()
	cusage, _ := (C.uint)(usage), cgoAllocsUnknown
...
// CodecVersionStr function as declared in vpx/vpx_codec.h:268
...
// CodecVersionExtraStr function as declared in vpx/vpx_codec.h:277
...
// CodecBuildConfig function as declared in vpx/vpx_codec.h:285
...
// CodecIfaceName function as declared in vpx/vpx_codec.h:294
...
// CodecErrToString function as declared in vpx/vpx_codec.h:306
...
// CodecErrorDetail function as declared in vpx/vpx_codec.h:330
...
// CodecDestroy function as declared in vpx/vpx_codec.h:349
...
// CodecGetCaps function as declared in vpx/vpx_codec.h:358
...
// ImageAlloc function as declared in vpx/vpx_image.h:143
...
// ImageWrap function as declared in vpx/vpx_image.h:166
func ImageWrap(img *Image, fmt ImageFormat, dW uint32, dH uint32, strideAlign uint32, imgData *byte) *Image {
	cimg, _ := img.PassRef()
	cfmt, _ := (C.vpx_img_fmt_t)(fmt), cgoAllocsUnknown
	cdW, _ := (C.uint)(dW), cgoAllocsUnknown
	cdH, _ := (C.uint)(dH), cgoAllocsUnknown
	cstrideAlign, _ := (C.uint)(strideAlign), cgoAllocsUnknown
...
// ImageSetRect function as declared in vpx/vpx_image.h:183
...
// ImageFlip function as declared in vpx/vpx_image.h:193
func ImageFlip(img *Image) {
	cimg, _ := img.PassRef()
	C.vpx_img_flip(cimg)
}

// ImageFree function as declared in vpx/vpx_image.h:201
func ImageFree(img *Image) {
	cimg, _ := img.PassRef()
	C.vpx_img_free(cimg)
}

// CodecDecInitVer function as declared in vpx/vpx_decoder.h:135
...
// CodecPeekStreamInfo function as declared in vpx/vpx_decoder.h:164
...
// CodecGetStreamInfo function as declared in vpx/vpx_decoder.h:182
...
// CodecDecode function as declared in vpx/vpx_decoder.h:215
...
// CodecGetFrame function as declared in vpx/vpx_decoder.h:235
...
// CodecRegisterPutFrameCb function as declared in vpx/vpx_decoder.h:270
...
// CodecRegisterPutSliceCb function as declared in vpx/vpx_decoder.h:311
